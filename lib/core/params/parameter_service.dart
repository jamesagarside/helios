...
class ParameterService {
  ...
  /// Export only the parameters that differ from their default — the GCS
  /// equivalent of Betaflight's `diff`. Empty when no defaults are known.
  ...
  Future<void> saveToFile(String path) async {
    ...
    await File(normalized).writeAsString(exportToParamFile());
  }
